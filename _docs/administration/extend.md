...
This section of the documentation is designed to provide detailed developer information for core functionality provided by Tripal Cultivate. The intent is to guide administrators and developers on how to extend this functionality through development of extension modules and how to troubleshoot any issues they may come accross.
